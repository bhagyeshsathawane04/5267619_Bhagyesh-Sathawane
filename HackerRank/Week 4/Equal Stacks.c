...
int sum1 = 0, sum2 = 0, sum3 = 0;
    ...
    // Keep reducing tallest stack until all sums are equal or any stack is empty
    while (!(sum1 == sum2 && sum2 == sum3)) {
        // If any stack becomes empty, no equal height possible
    ...
    return sum1;  // At this point all sums are equal
}
